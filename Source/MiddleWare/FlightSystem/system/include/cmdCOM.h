 ...
 * available for payload data, so we have to subtract 2 bytes for the frame
 * number, 1 byte for the telemetry type, 1 byte for the node number and,
 * 4 bytes for the number of data samples inside a frame.
 * COM_FRAME_MAX_LEN = 200-2-1-1-4 = 192 bytes max
 */
...
typedef struct com_frame_aligned{
    uint16_t nframe;        ///< Frame number
    uint8_t type;           ///< Telemetry type
    uint8_t node;           ///< Node of origin
    uint32_t ndata;         ///< Number of data samples (structs) in the frame
 ...
 */
cmd_result_t com_ping(cmd_args_t* params);
 ...
 * @return CMD_OK if executed correctly or CMD_ERROR in case of errors
 */
cmd_result_t com_send_rpt(cmd_args_t* params);
 ...
 * @return CMD_OK if executed correctly or CMD_ERROR in case of errors
 */
cmd_result_t com_send_cmd(cmd_args_t* params);
 ...
 *
 */
cmd_result_t com_send_tc_frame(cmd_args_t* params);
 ...
 * @endcode
 */
cmd_result_t com_send_data(cmd_args_t* params);
 ...
 * @return CMD_OK
 */
cmd_result_t com_debug(cmd_args_t* params);
 ...
 * @return CMD_OK if executed correctly, CMD_ERROR in case of failures, or CMD_ERROR_SYNTAX in case of parameters errors.
 */
cmd_result_t com_set_time_node(cmd_args_t* params);
 ...
 * @endcode
 */
cmd_result_t com_reset_wdt(cmd_args_t* params);
 ...
 * @return
 */
cmd_result_t com_get_hk(cmd_args_t* params);
 ...
 *
 */
cmd_result_t com_get_config(cmd_args_t* params);
 ...
 *
 */
cmd_result_t com_set_config(cmd_args_t* params);

/* TODO: Add documentation */
cmd_result_t com_update_status_vars(cmd_args_t* params);

/* TODO: ADD documentation */
cmd_result_t com_set_beacon(cmd_args_t* params);
